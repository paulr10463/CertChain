...
export const TransactionByHash = () => {
    ...
    , [transactionsData, merkleRootHash]);

    function checkTransactionWithMerkeRootHash(){
         enviarPeticion();
    }
    ...
    return (
        <>
            <div>
                ...
                <button onClick={checkTransactionWithMerkeRootHash} style={{marginTop:"0.5rem"}}>Buscar</button>
                {showResult && (
                <div>
                    {transactionResult &&(
                        <div>
                            <p>Transacción encontrada:</p>
